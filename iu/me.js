 ...
 */
function calcGpa() {
  const KelvinMacha = document.getElementById("gpa-calc");
  ...
  if (gpa >= 0){
    KelvinMacha.textContent = "Your GPA is " + gpa.toFixed(2);   
  } else {
    KelvinMacha.textContent = "Please enter your correct grade and credit units";    
  }
